Gem::Specification.new do |s|
  ...
  s.files = ["lib/snippet.rb", "lib/snippets/helper.rb", "lib/snippets/parsers/html.rb", "lib/snippets/parsers/textile.rb", "rails/init.rb", "README.textile", "MIT-LICENSE", "Rakefile"]
